...
class UtilisateursController extends Controller
{
    ...
    public function utilisateursForm(Request $request)
    {
        ...
        return redirect(route('login'))->with('success', 'You are registered. You\'ve just receive an email to confirm your account. Please login now and then click on \'Verify email\' in your mailbox at ' . $request->email);
    }
